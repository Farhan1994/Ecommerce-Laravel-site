            ...
            <main>
                <div class="row contacts">
                    <div class="col invoice-to">
                        ...
                        <div class="phone">{{ $order->phone_no }}</div>
                    </div>
                ...
                <table border="0" cellspacing="0" cellpadding="0">
                    ...
                    @foreach ($order->carts as $cart)
                        <tr>
                            ...
                            <td class="text-left">
                            <h3><a href="{{ route('products.details', $cart->product->slug) }}">{{ $cart->product->title }}</a></h3>
                            </td>
                            <td class="qty">{{ $cart->product_quantity }}</td>
                            <td class="unit">{{ $cart->product->price }} Taka</td>
                            <td class="total">@php
                    ...
                    <tfoot>
                        ...
                        <tr>
                            ...
                            <td>{{ $order->custom_discount }} Taka</td>
                        </tr>
                        <tr>
                            <td colspan="2"></td>
                            <td colspan="2">Delivery Charge</td>
                            <td>{{ $order->shipping_charge }} Taka</td>
                        </tr>
                        <tr>
                            <td colspan="2"></td>
                            <td colspan="2">GRAND TOTAL</td>
                            <td>{{ $total_price + $order->shipping_charge - $order->custom_discount }} Taka</td>
                        </tr>
                    </tfoot>
                </table>
            @endif    
